...
const ChooseYourBreakfast = () => {
  return (
    <div className="mb-28 flex w-56 flex-col rounded-lg bg-primary-text-color p-2 tablet:absolute tablet:right-0 tablet:mb-0 tablet:w-[265px] tablet:p-3 desktop:bottom-28 desktop:right-24 desktop:w-[300px] desktop:p-4">
